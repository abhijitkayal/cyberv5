          ...
          {calendarDays.map((day) => {
            ...
            return (
              <div
                key={day.toISOString()}
                className={cn(
                  "relative border-r border-b last:border-r-0 p-2 min-h-[120px] hover:bg-muted/50 cursor-pointer transition-colors bg-background text-foreground",
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <h2 className="text-lg font-semibold min-w-[140px] text-center text-foreground">
              ...
              <div className="flex items-center space-x-2">
                <div className="hidden sm:flex items-center space-x-2">
                  <Button variant="ghost" size="sm" className="text-xs text-foreground border">
