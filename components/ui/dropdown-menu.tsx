...
function DropdownMenuContent({ className = "", align = "start", sideOffset = 4, ...props }: any) {
  return (
...
function DropdownMenuItem({ className = "", inset = false, variant = "default", ...props }: any) {
...
function DropdownMenuCheckboxItem({ className = "", children, checked, inset = false, ...props }: any) {
  return (
...
function DropdownMenuRadioItem({ className = "", children, inset = false, ...props }: any) {
  return (
...
function DropdownMenuLabel({ className = "", inset = false, ...props }: any) {
...
function DropdownMenuSubTrigger({ className = "", inset = false, children, ...props }: any) {
  return (
